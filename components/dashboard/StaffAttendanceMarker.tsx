...
import InputField, { FormFieldType } from "../form/ui/InputField";
import { staffAttendanceSchema, StaffAttendanceSchema } from "@/lib/validation";
...
const StaffAttendanceMarker = ({
  ...
  const form = useForm<StaffAttendanceSchema>({
    resolver: zodResolver(staffAttendanceSchema(type)),
    defaultValues: {
