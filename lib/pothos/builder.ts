...
export const builder = new SchemaBuilder<{
  ...
  scopeAuth: {
    ...
    authScopes: async (context) => ({
      ...
      manager: context.accessLevel === "manager",
      teacher: context.accessLevel === "teacher",
      finance: context.accessLevel === "finance",
      admin: context.accessLevel === "administration",
      parent: context.accessLevel === "parent",
    }),
  },
});
